    ...
    "Govy Go Benchmark": [
      ...
      },
      {
        ...
        "benches": [
          ...
          },
          {
            "name": "BenchmarkStringDenyRegexp",
            "value": 679.6,
            "unit": "ns/op\t     289 B/op\t       8 allocs/op",
            "extra": "1747651 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDenyRegexp - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringDNSLabel",
            "value": 16382,
            "unit": "ns/op\t    6993 B/op\t     182 allocs/op",
            "extra": "72475 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDNSLabel - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringUUID",
            "value": 20497,
            "unit": "ns/op\t   17863 B/op\t     293 allocs/op",
            "extra": "58476 times\n4 procs"
          },
          {
            "name": "BenchmarkStringUUID - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringRegexp",
            "value": 161599802,
            "unit": "ns/op\t334343472 B/op\t  281375 allocs/op",
            "extra": "7 times\n4 procs"
          },
          {
            "name": "BenchmarkStringRegexp - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringTimeZone",
            "value": 206446,
            "unit": "ns/op\t  338218 B/op\t     280 allocs/op",
            "extra": "5332 times\n4 procs"
          },
          {
            "name": "BenchmarkStringTimeZone - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "0a304ec75c5167668c3e77389aa13be116c8be6b",
          "message": "feat: Introduce message templates (#10)\n\n## Motivation\r\n\r\nSometimes there's a need for a more advanced mechanism of error message\r\noverriding and manipulation other than overriding the whole message with\r\n`WithMessage`.\r\nThe most prominent example of such use case are translations.\r\nCurrently govy does not support translations in anyway.\r\n\r\nSolution which would open up support for the aforementioned use cases is\r\nintroducing templating to all the builtin rules.\r\nSimilar solution was implemented by Fluent Validation\r\n[here](https://docs.fluentvalidation.net/en/latest/configuring.html).\r\n\r\nGo already has a native [templating\r\nsystem](https://pkg.go.dev/text/template) which we can utilize to\r\nachieve a similar API to the Fluent's version.\r\nI'm opting for a verbose placeholders methods instead of extending\r\n`WithMessage` functionality, one which would accept `template.Template`\r\n(gives more power over the template initialization, parsing etc.)\r\nanother which would accept a raw template string.\r\n\r\n## Summary\r\n\r\n```go\r\npackage examples\r\n\r\nimport (\r\n\t\"fmt\"\r\n\r\n\t\"github.com/nobl9/govy/pkg/govy\"\r\n\t\"github.com/nobl9/govy/pkg/rules\"\r\n)\r\n\r\nfunc Example_messageTemplates() {\r\n\ttype Teacher struct {\r\n\t\tName string `json:\"name\"`\r\n\t}\r\n\r\n\ttemplateString := \"name length should be between {{ .MinLength }} and {{ .MaxLength }} {{ formatExamples .Examples }}\"\r\n\r\n\tv := govy.New(\r\n\t\tgovy.For(func(t Teacher) string { return t.Name }).\r\n\t\t\tWithName(\"name\").\r\n\t\t\tRules(\r\n\t\t\t\trules.StringLength(5, 10).\r\n\t\t\t\t\tWithExamples(\"Joanna\", \"Jerry\").\r\n\t\t\t\t\tWithMessageTemplateString(templateString),\r\n\t\t\t),\r\n\t).WithName(\"Teacher\")\r\n\r\n\tteacher := Teacher{Name: \"Tom\"}\r\n\terr := v.Validate(teacher)\r\n\tif err != nil {\r\n\t\tfmt.Println(err)\r\n\t}\r\n\r\n\t// Output:\r\n\t// Validation for Teacher has failed for the following properties:\r\n\t//   - 'name' with value 'Tom':\r\n\t//     - name length should be between 5 and 10 (e.g. 'Joanna', 'Jerry')\r\n```\r\n\r\n### Creating templates\r\n\r\nMessage templates can be either provided in form of a\r\n`template.Template` or a raw template string.\r\n\r\n### Template variables\r\n\r\nVariables used to execute templates are defined exclusively by\r\n`govy.TemplateVars` struct.\r\nBuiltin variables are defined at the top level, user defined variables\r\nmust be provided via `Custom` field of `govy.TemplateVars`.\r\n\r\n### Adding template support to custom rules\r\n\r\nUsers can add templating support to their custom rules by returning a\r\n`govy.RuleErrorTemplate` error.\r\nThis `error` is not meant to be called directly but rather it serves as\r\na container destined to be unpacked inside `govy.Rule.Validate`\r\nfunction.\r\n\r\nCurrently, if a template was added to a rule which does not return\r\n`govy.RuleErrorTemplate` it will panic in runtime. This behaviour is\r\nexpected to be improved upon.\r\n\r\n### Builtin template functions\r\n\r\nCommon, builtin template functions (like `formatExamples`) can be added\r\nto the user's templates with `govy.AddTemplateFunctions` function.\r\nThe following functions are added (more are expected to be defined as\r\nall builtin rules adopt templating):\r\n- `formatExamples`\r\n- `joinStringSlice`\r\n\r\nTo improve the documentation for these builtin functions I decided to\r\ndocument them at their definitions, combine these code comments and add\r\nthem to `govy.AddTemplateFunctions` code docs.\r\n\r\nThe automation for this process is done with `go generate` and a custom\r\nprogram called `docextractor`.\r\n\r\n## Release Notes\r\n\r\nAdded `govy.Rule.WithMessageTemplate` and\r\n`govy.Rule.WithMessageTemplateString` functions which allow advanced\r\nmanipulation of the error message produced by `govy.Rule`.\r\n\r\nUsers can add templating support to their rules by returning a new\r\nerror: `govy.RuleErrorTemplate`.\r\nThis error is a simple container that passes `govy.TemplateVars` to the\r\nrule evaluation logic which uses it as variables to execute an error\r\nmessage template.\r\nUser defined variables should be provided via `govy.TemplateVars.Custom`\r\nfield which accepts `any` value.\r\n\r\nAdded `govy.AddTemplateFunctions` which adds builtin template functions\r\nto the user's `template.Template` instance.",
          "timestamp": "2025-01-21T16:35:15+01:00",
          "tree_id": "b71512daf0ee446a748afcaf6c449c0b06b6da30",
          "url": "https://github.com/nobl9/govy/commit/0a304ec75c5167668c3e77389aa13be116c8be6b"
        },
        "date": 1737473859197,
        "tool": "go",
        "benches": [
          ...
          },
          {
            "name": "BenchmarkStringLength",
            "value": 11148,
            "unit": "ns/op\t    3216 B/op\t      86 allocs/op",
            "extra": "105712 times\n4 procs"
          },
          {
            "name": "BenchmarkStringLength - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringDNSLabel",
            "value": 16283,
            "unit": "ns/op\t    6996 B/op\t     182 allocs/op",
            "extra": "73021 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDNSLabel - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringRegexp",
            "value": 166144768,
            "unit": "ns/op\t334344461 B/op\t  281382 allocs/op",
            "extra": "7 times\n4 procs"
          },
          {
            "name": "BenchmarkStringRegexp - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "95a6427d087d719c26f6b9e37adfa2635983f3b1",
          "message": "chore: Update jetpack-io/devbox-install-action action to v0.12.0 (#65)\n\nThis PR contains the following updates:\n\n| Package | Type | Update | Change |\n|---|---|---|---|\n|\n[jetpack-io/devbox-install-action](https://redirect.github.com/jetpack-io/devbox-install-action)\n| action | minor | `v0.11.0` -> `v0.12.0` |\n\n---\n\n### Release Notes\n\n<details>\n<summary>jetpack-io/devbox-install-action\n(jetpack-io/devbox-install-action)</summary>\n\n###\n[`v0.12.0`](https://redirect.github.com/jetify-com/devbox-install-action/releases/tag/v0.12.0)\n\n[Compare\nSource](https://redirect.github.com/jetpack-io/devbox-install-action/compare/v0.11.0...v0.12.0)\n\n##### What's Changed\n\n- Bump DeterminateSystems/nix-installer-action from 10 to 11 by\n[@&#8203;dependabot](https://redirect.github.com/dependabot) in\n[https://github.com/jetify-com/devbox-install-action/pull/48](https://redirect.github.com/jetify-com/devbox-install-action/pull/48)\n- fix: use devbox from ~/.local/bin by\n[@&#8203;supershal](https://redirect.github.com/supershal) in\n[https://github.com/jetify-com/devbox-install-action/pull/50](https://redirect.github.com/jetify-com/devbox-install-action/pull/50)\n- Update action.yml devbox CLI cache location by\n[@&#8203;LucilleH](https://redirect.github.com/LucilleH) in\n[https://github.com/jetify-com/devbox-install-action/pull/52](https://redirect.github.com/jetify-com/devbox-install-action/pull/52)\n- Bump DeterminateSystems/nix-installer-action from 11 to 12 by\n[@&#8203;dependabot](https://redirect.github.com/dependabot) in\n[https://github.com/jetify-com/devbox-install-action/pull/53](https://redirect.github.com/jetify-com/devbox-install-action/pull/53)\n- Update README.md by\n[@&#8203;mskonovalov](https://redirect.github.com/mskonovalov) in\n[https://github.com/jetify-com/devbox-install-action/pull/54](https://redirect.github.com/jetify-com/devbox-install-action/pull/54)\n- Bump DeterminateSystems/nix-installer-action from 12 to 13 by\n[@&#8203;dependabot](https://redirect.github.com/dependabot) in\n[https://github.com/jetify-com/devbox-install-action/pull/55](https://redirect.github.com/jetify-com/devbox-install-action/pull/55)\n- Bump DeterminateSystems/nix-installer-action from 13 to 16 by\n[@&#8203;dependabot](https://redirect.github.com/dependabot) in\n[https://github.com/jetify-com/devbox-install-action/pull/62](https://redirect.github.com/jetify-com/devbox-install-action/pull/62)\n- Add nix version as part of the nix cache key by\n[@&#8203;LucilleH](https://redirect.github.com/LucilleH) in\n[https://github.com/jetify-com/devbox-install-action/pull/65](https://redirect.github.com/jetify-com/devbox-install-action/pull/65)\n- Consolidate devbox cli path by\n[@&#8203;LucilleH](https://redirect.github.com/LucilleH) in\n[https://github.com/jetify-com/devbox-install-action/pull/66](https://redirect.github.com/jetify-com/devbox-install-action/pull/66)\n- Change nix version env var by\n[@&#8203;LucilleH](https://redirect.github.com/LucilleH) in\n[https://github.com/jetify-com/devbox-install-action/pull/68](https://redirect.github.com/jetify-com/devbox-install-action/pull/68)\n\n##### New Contributors\n\n- [@&#8203;supershal](https://redirect.github.com/supershal) made their\nfirst contribution in\n[https://github.com/jetify-com/devbox-install-action/pull/50](https://redirect.github.com/jetify-com/devbox-install-action/pull/50)\n- [@&#8203;mskonovalov](https://redirect.github.com/mskonovalov) made\ntheir first contribution in\n[https://github.com/jetify-com/devbox-install-action/pull/54](https://redirect.github.com/jetify-com/devbox-install-action/pull/54)\n\n**Full Changelog**:\nhttps://github.com/jetify-com/devbox-install-action/compare/v0.11.0...v0.12.0\n\n</details>\n\n---\n\n### Configuration\n\n📅 **Schedule**: Branch creation - \"* 0-4,22-23 * * 1-5,* * * * 0,6\"\n(UTC), Automerge - At any time (no schedule defined).\n\n🚦 **Automerge**: Enabled.\n\n♻ **Rebasing**: Whenever PR becomes conflicted, or you tick the\nrebase/retry checkbox.\n\n🔕 **Ignore**: Close this PR and you won't be reminded about this update\nagain.\n\n---\n\n- [ ] <!-- rebase-check -->If you want to rebase/retry this PR, check\nthis box\n\n---\n\nThis PR was generated by [Mend Renovate](https://mend.io/renovate/).\nView the [repository job\nlog](https://developer.mend.io/github/nobl9/govy).\n\n<!--renovate-debug:eyJjcmVhdGVkSW5WZXIiOiIzOS4xMDcuMCIsInVwZGF0ZWRJblZlciI6IjM5LjEyNS4xIiwidGFyZ2V0QnJhbmNoIjoibWFpbiIsImxhYmVscyI6WyJkZXBlbmRlbmNpZXMiLCJnaXRodWItYWN0aW9ucyIsInJlbm92YXRlIl19-->\n\nCo-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>",
          "timestamp": "2025-02-02T15:25:50+01:00",
          "tree_id": "af6b6eefb5816383d660292a3a12c8d546024825",
          "url": "https://github.com/nobl9/govy/commit/95a6427d087d719c26f6b9e37adfa2635983f3b1"
        },
        "date": 1738506532715,
        "tool": "go",
        "benches": [
          ...
          },
          {
            "name": "BenchmarkStringDNSLabel",
            "value": 16369,
            "unit": "ns/op\t    6994 B/op\t     182 allocs/op",
            "extra": "72321 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDNSLabel - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringDirPath",
            "value": 37538,
            "unit": "ns/op\t    7273 B/op\t     103 allocs/op",
            "extra": "31978 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDirPath - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringRegexp",
            "value": 164711991,
            "unit": "ns/op\t334343090 B/op\t  281372 allocs/op",
            "extra": "7 times\n4 procs"
          },
          {
            "name": "BenchmarkStringRegexp - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringTimeZone",
            "value": 207461,
            "unit": "ns/op\t  338220 B/op\t     280 allocs/op",
            "extra": "5347 times\n4 procs"
          },
          {
            "name": "BenchmarkStringTimeZone - ns/op",
      ...
      },
      {
        ...
        "benches": [
          ...
          },
          {
            "name": "BenchmarkStringDNSLabel",
            "value": 16116,
            "unit": "ns/op\t    6987 B/op\t     182 allocs/op",
            "extra": "74162 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDNSLabel - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringFilePath",
            "value": 36619,
            "unit": "ns/op\t    7610 B/op\t     108 allocs/op",
            "extra": "31843 times\n4 procs"
          },
          {
            "name": "BenchmarkStringFilePath - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringRegexp",
            "value": 163848694,
            "unit": "ns/op\t334341821 B/op\t  281364 allocs/op",
            "extra": "7 times\n4 procs"
          },
          {
            "name": "BenchmarkStringRegexp - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringTimeZone",
            "value": 204836,
            "unit": "ns/op\t  338221 B/op\t     280 allocs/op",
            "extra": "5637 times\n4 procs"
          },
          {
            "name": "BenchmarkStringTimeZone - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "ad1f1a9396c7ea318c1602d489c58d2a8b424665",
          "message": "chore: Correct benchmarks (#72)\n\n## Motivation\r\n\r\nCurrently benchmarks are run in a way that is not very realistic, i.e.\r\nthe rule is initialized in every run.\r\nInstead, what we should do is initialize the rule once and run\r\nbenchmarks on the initalized rule.\r\n\r\nIn the future, If we want to benchmark rule initalization, we should do\r\nthat in a separate benchmark.\r\n\r\n## Summary\r\n\r\nInstead of:\r\n\r\n```go\r\nfor range b.N {\r\n\tfor _, tc := range sliceUniqueTestCases {\r\n\t\t_ = SliceUnique(tc.hashFunc, tc.constraints...).Validate(tc.slice)\r\n\t}\r\n}\r\n```\r\n\r\nwe now run:\r\n\r\n```go\r\nfor _, tc := range sliceUniqueTestCases {\r\n\trule := SliceUnique(tc.hashFunc, tc.constraints...)\r\n\tfor range b.N {\r\n\t\t_ = rule.Validate(tc.slice)\r\n\t}\r\n}\r\n```",
          "timestamp": "2025-02-09T23:33:08+01:00",
          "tree_id": "37502998a54f906332e8a8c5fae3d916c4974cd5",
          "url": "https://github.com/nobl9/govy/commit/ad1f1a9396c7ea318c1602d489c58d2a8b424665"
        },
        "date": 1739140538187,
        "tool": "go",
        "benches": [
          ...
          },
          {
            "name": "BenchmarkStringLength",
            "value": 2513,
            "unit": "ns/op\t    1056 B/op\t      26 allocs/op",
            "extra": "467019 times\n4 procs"
          },
          {
            "name": "BenchmarkStringLength - ns/op",
          ...
          },
          {
            "name": "BenchmarkMutuallyExclusive",
            "value": 4583,
            "unit": "ns/op\t    1800 B/op\t      63 allocs/op",
            "extra": "259742 times\n4 procs"
          },
          {
            "name": "BenchmarkMutuallyExclusive - ns/op",
          ...
          },
          {
            "name": "BenchmarkOneOfProperties",
            "value": 1061,
            "unit": "ns/op\t     344 B/op\t      12 allocs/op",
            "extra": "1000000 times\n4 procs"
          },
          {
            "name": "BenchmarkOneOfProperties - ns/op",
          ...
          },
          {
            "name": "BenchmarkRequired",
            "value": 586.9,
            "unit": "ns/op\t     432 B/op\t      12 allocs/op",
            "extra": "2040722 times\n4 procs"
          },
          {
            "name": "BenchmarkRequired - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringDNSLabel",
            "value": 9114,
            "unit": "ns/op\t    4054 B/op\t      70 allocs/op",
            "extra": "129159 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDNSLabel - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringUUID",
            "value": 10338,
            "unit": "ns/op\t   11619 B/op\t     143 allocs/op",
            "extra": "113294 times\n4 procs"
          },
          {
            "name": "BenchmarkStringUUID - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringEmail",
            "value": 7407,
            "unit": "ns/op\t    2936 B/op\t     122 allocs/op",
            "extra": "158619 times\n4 procs"
          },
          {
            "name": "BenchmarkStringEmail - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringMAC",
            "value": 780.2,
            "unit": "ns/op\t     504 B/op\t      18 allocs/op",
            "extra": "1546076 times\n4 procs"
          },
          {
            "name": "BenchmarkStringMAC - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringIP",
            "value": 1089,
            "unit": "ns/op\t     512 B/op\t      20 allocs/op",
            "extra": "972452 times\n4 procs"
          },
          {
            "name": "BenchmarkStringIP - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringIPv4",
            "value": 1208,
            "unit": "ns/op\t     576 B/op\t      22 allocs/op",
            "extra": "913446 times\n4 procs"
          },
          {
            "name": "BenchmarkStringIPv4 - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringIPv6",
            "value": 1327,
            "unit": "ns/op\t     704 B/op\t      26 allocs/op",
            "extra": "813817 times\n4 procs"
          },
          {
            "name": "BenchmarkStringIPv6 - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringCIDR",
            "value": 2325,
            "unit": "ns/op\t    1200 B/op\t      50 allocs/op",
            "extra": "483157 times\n4 procs"
          },
          {
            "name": "BenchmarkStringCIDR - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringCIDRv4",
            "value": 4331,
            "unit": "ns/op\t    2344 B/op\t      98 allocs/op",
            "extra": "271218 times\n4 procs"
          },
          {
            "name": "BenchmarkStringCIDRv4 - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringCIDRv6",
            "value": 2791,
            "unit": "ns/op\t    1584 B/op\t      62 allocs/op",
            "extra": "403242 times\n4 procs"
          },
          {
            "name": "BenchmarkStringCIDRv6 - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringJSON",
            "value": 889.2,
            "unit": "ns/op\t     424 B/op\t      17 allocs/op",
            "extra": "1357838 times\n4 procs"
          },
          {
            "name": "BenchmarkStringJSON - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringFileSystemPath",
            "value": 35614,
            "unit": "ns/op\t    7064 B/op\t      81 allocs/op",
            "extra": "33619 times\n4 procs"
          },
          {
            "name": "BenchmarkStringFileSystemPath - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringFilePath",
            "value": 36260,
            "unit": "ns/op\t    7176 B/op\t      90 allocs/op",
            "extra": "33130 times\n4 procs"
          },
          {
            "name": "BenchmarkStringFilePath - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringDirPath",
            "value": 35702,
            "unit": "ns/op\t    6872 B/op\t      85 allocs/op",
            "extra": "33332 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDirPath - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringMatchFileSystemPath",
            "value": 4626,
            "unit": "ns/op\t    1840 B/op\t      49 allocs/op",
            "extra": "249750 times\n4 procs"
          },
          {
            "name": "BenchmarkStringMatchFileSystemPath - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringRegexp",
            "value": 159488160,
            "unit": "ns/op\t334342973 B/op\t  281350 allocs/op",
            "extra": "7 times\n4 procs"
          },
          {
            "name": "BenchmarkStringRegexp - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringCrontab",
            "value": 95163,
            "unit": "ns/op\t   51266 B/op\t    1271 allocs/op",
            "extra": "12586 times\n4 procs"
          },
          {
            "name": "BenchmarkStringCrontab - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringDateTime",
            "value": 3874,
            "unit": "ns/op\t    2528 B/op\t      48 allocs/op",
            "extra": "296205 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDateTime - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringTimeZone",
            "value": 204018,
            "unit": "ns/op\t  336940 B/op\t     216 allocs/op",
            "extra": "5442 times\n4 procs"
          },
          {
            "name": "BenchmarkStringTimeZone - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringAlpha",
            "value": 1400,
            "unit": "ns/op\t     384 B/op\t      12 allocs/op",
            "extra": "792258 times\n4 procs"
          },
          {
            "name": "BenchmarkStringAlpha - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringAlphaUnicode",
            "value": 2661,
            "unit": "ns/op\t     448 B/op\t      14 allocs/op",
            "extra": "422491 times\n4 procs"
          },
          {
            "name": "BenchmarkStringAlphaUnicode - ns/op",
          ...
          },
          {
            "name": "BenchmarkSliceUnique",
            "value": 3158,
            "unit": "ns/op\t    1254 B/op\t      45 allocs/op",
            "extra": "366421 times\n4 procs"
          },
          {
            "name": "BenchmarkSliceUnique - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d8178db328e274f167a5e1947b1cfa2cba8a7fc3",
          "message": "feat: Add templating to all the builtin rules (#74)\n\nAdded templates support to all the builtin rules.\r\n\r\n## Breaking Changes\r\n\r\n`rules.OneOf` error has been changed, instead of `must be one of [this,\r\nthat]` it will now return `must be one of: this, that`.",
          "timestamp": "2025-02-12T12:20:48+01:00",
          "tree_id": "e5b11ef0e833e9e3f5f6c05f2cf3476eff60d7e4",
          "url": "https://github.com/nobl9/govy/commit/d8178db328e274f167a5e1947b1cfa2cba8a7fc3"
        },
        "date": 1739359417191,
        "tool": "go",
        "benches": [
          ...
          },
          {
            "name": "BenchmarkOneOf",
            "value": 2083,
            "unit": "ns/op\t     768 B/op\t      22 allocs/op",
            "extra": "533539 times\n4 procs"
          },
          {
            "name": "BenchmarkOneOf - ns/op",
          ...
          },
          {
            "name": "BenchmarkMutuallyExclusive",
            "value": 14478,
            "unit": "ns/op\t    5441 B/op\t     143 allocs/op",
            "extra": "81936 times\n4 procs"
          },
          {
            "name": "BenchmarkMutuallyExclusive - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringDenyRegexp",
            "value": 1268,
            "unit": "ns/op\t     606 B/op\t      13 allocs/op",
            "extra": "891134 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDenyRegexp - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringDNSLabel",
            "value": 24845,
            "unit": "ns/op\t    9681 B/op\t     180 allocs/op",
            "extra": "48225 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDNSLabel - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringContains",
            "value": 6020,
            "unit": "ns/op\t    2336 B/op\t      62 allocs/op",
            "extra": "196537 times\n4 procs"
          },
          {
            "name": "BenchmarkStringContains - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringExcludes",
            "value": 7885,
            "unit": "ns/op\t    3200 B/op\t      80 allocs/op",
            "extra": "149596 times\n4 procs"
          },
          {
            "name": "BenchmarkStringExcludes - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringStartsWith",
            "value": 7690,
            "unit": "ns/op\t    2472 B/op\t      75 allocs/op",
            "extra": "153408 times\n4 procs"
          },
          {
            "name": "BenchmarkStringStartsWith - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringEndsWith",
            "value": 7672,
            "unit": "ns/op\t    2456 B/op\t      75 allocs/op",
            "extra": "152055 times\n4 procs"
          },
          {
            "name": "BenchmarkStringEndsWith - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringGitRef",
            "value": 256275,
            "unit": "ns/op\t   76410 B/op\t    2336 allocs/op",
            "extra": "4417 times\n4 procs"
          },
          {
            "name": "BenchmarkStringGitRef - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringRegexp",
            "value": 160266926,
            "unit": "ns/op\t334354053 B/op\t  281513 allocs/op",
            "extra": "7 times\n4 procs"
          },
          {
            "name": "BenchmarkStringRegexp - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringCrontab",
            "value": 381597,
            "unit": "ns/op\t  184415 B/op\t    3890 allocs/op",
            "extra": "2887 times\n4 procs"
          },
          {
            "name": "BenchmarkStringCrontab - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringTimeZone",
            "value": 238760,
            "unit": "ns/op\t  343320 B/op\t     328 allocs/op",
            "extra": "4838 times\n4 procs"
          },
          {
            "name": "BenchmarkStringTimeZone - ns/op",
          ...
          },
          {
            "name": "BenchmarkSliceUnique",
            "value": 24658,
            "unit": "ns/op\t    6793 B/op\t     210 allocs/op",
            "extra": "48458 times\n4 procs"
          },
          {
            "name": "BenchmarkSliceUnique - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "4ff748ed0224f289b3aba66bdb7662ed8def911a",
          "message": "chore: Improve docs for errore message templates (#75)",
          "timestamp": "2025-02-12T14:17:06+01:00",
          "tree_id": "3a409d97b4c976a356155b0f41c79475c5cf738c",
          "url": "https://github.com/nobl9/govy/commit/4ff748ed0224f289b3aba66bdb7662ed8def911a"
        },
        "date": 1739366397949,
        "tool": "go",
        "benches": [
          ...
          },
          {
            "name": "BenchmarkStringDNSLabel",
            "value": 24710,
            "unit": "ns/op\t    9679 B/op\t     180 allocs/op",
            "extra": "48370 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDNSLabel - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringASCII",
            "value": 5783,
            "unit": "ns/op\t    2400 B/op\t      52 allocs/op",
            "extra": "204494 times\n4 procs"
          },
          {
            "name": "BenchmarkStringASCII - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringGitRef",
            "value": 257905,
            "unit": "ns/op\t   76411 B/op\t    2336 allocs/op",
            "extra": "4387 times\n4 procs"
          },
          {
            "name": "BenchmarkStringGitRef - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringDirPath",
            "value": 40970,
            "unit": "ns/op\t    9897 B/op\t     139 allocs/op",
            "extra": "29072 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDirPath - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringRegexp",
            "value": 171830326,
            "unit": "ns/op\t334351749 B/op\t  281497 allocs/op",
            "extra": "7 times\n4 procs"
          },
          {
            "name": "BenchmarkStringRegexp - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringTimeZone",
            "value": 245598,
            "unit": "ns/op\t  343321 B/op\t     328 allocs/op",
            "extra": "4683 times\n4 procs"
          },
          {
            "name": "BenchmarkStringTimeZone - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1b05a81eb974d331a9e61c5553b47d5d1bb4aeb0",
          "message": "chore: Pin devbox version (#79)\n\nCurrent latest version is 0.14.0 but the `devbox.lock` file was created\nwith devbox version 0.13.7.\nWhile this shouldn't matter for some reason the lock file is being\nupdated in GH actions when merging to main.\nThis PR is an attempt at fixing this.",
          "timestamp": "2025-03-15T16:13:49+01:00",
          "tree_id": "e6707d34b527700023b33f447765daf13f8e4b75",
          "url": "https://github.com/nobl9/govy/commit/1b05a81eb974d331a9e61c5553b47d5d1bb4aeb0"
        },
        "date": 1742051807380,
        "tool": "go",
        "benches": [
          ...
          },
          {
            "name": "BenchmarkStringDNSLabel",
            "value": 24296,
            "unit": "ns/op\t    9690 B/op\t     180 allocs/op",
            "extra": "49328 times\n4 procs"
          },
          {
            "name": "BenchmarkStringDNSLabel - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringRegexp",
            "value": 163303521,
            "unit": "ns/op\t334353902 B/op\t  281512 allocs/op",
            "extra": "7 times\n4 procs"
          },
          {
            "name": "BenchmarkStringRegexp - ns/op",
          ...
          },
          {
            "name": "BenchmarkStringTimeZone",
            "value": 235458,
            "unit": "ns/op\t  343322 B/op\t     328 allocs/op",
            "extra": "4870 times\n4 procs"
          },
          {
            "name": "BenchmarkStringTimeZone - ns/op",
          ...
          },
          {
            ...
            "value": 20491,
            "unit": "ns/op\t    6886 B/op\t     110 allocs/op",
            "extra": "58542 times\n4 procs"
          },
          {
