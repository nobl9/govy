...
- [ExampleRule_WithDetails](#examplerule_withdetails)
- [ExampleRule_WithDetailsf](#examplerule_withdetailsf)
- [ExampleRule_WithExamples](#examplerule_withexamples)
- [ExampleRule_WithErrorCode](#examplerule_witherrorcode)
- [ExampleRule_WithMessage](#examplerule_withmessage)
- [ExampleRule_WithMessagef](#examplerule_withmessagef)
- [ExampleRule_WithMessageTemplateString](#examplerule_withmessagetemplatestring)
- [ExampleRule_WithMessageTemplate](#examplerule_withmessagetemplate)
- [ExampleAddTemplateFunctions](#exampleaddtemplatefunctions)
- [ExampleAddTemplateFunctions_formatExamples](#exampleaddtemplatefunctions_formatexamples)
- [ExampleAddTemplateFunctions_joinSlice](#exampleaddtemplatefunctions_joinslice)
- [ExampleAddTemplateFunctions_indent](#exampleaddtemplatefunctions_indent)
- [ExampleRule_WithDescription](#examplerule_withdescription)
- [ExampleRuleToPointer](#exampleruletopointer)
- [ExampleRuleSet](#exampleruleset)
- [ExampleRuleSetToPointer](#examplerulesettopointer)
- [ExampleRuleSet_Cascade](#exampleruleset_cascade)
