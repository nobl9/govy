...
Currently it has a single subcommand, [infername](#infername).
...
`infername` is a code generator that can be used to infer field names
for structs.
...
```shell
infername -dir <directory> -pkg <package> -filename <filename>
```

The following flags are available:

```text
Usage of govy infername:
  -dir string
...
```go
// Code generated by "infername -dir . -pkg main"; DO NOT EDIT.
