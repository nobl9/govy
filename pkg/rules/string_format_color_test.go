...
var stringRGBATestCases = []*stringFormatColorTestCase{
	...
	{in: "rgba(0,0,0,.5)", expectedError: errStringRGBA},
	{in: "rgba(0,0,0,0.)", expectedError: errStringRGBA},
...
var stringHSLATestCases = []*stringFormatColorTestCase{
	...
	{in: "hsla(120,50%,0%,.5)", expectedError: errStringHSLA},
	{in: "hsla(120,50%,0%,0.)", expectedError: errStringHSLA},
...
var stringCMYKTestCases = []*stringFormatColorTestCase{
	...
	{in: "cmyk(0.5%,0%,0%,0%)", expectedError: errStringCMYK},
}
