...
`StringISO3166Alpha2` emits an exact enum of accepted country codes.
The other ISO 3166 and ISO 4217 rules can also produce exact enums without a
custom vocabulary, but the resulting schemas can be large.
