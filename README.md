...
in the [rules](./pkg/rules) package which cover most of the common use cases.

#### Custom rules

If the predefined rules are not enough, you can always define your own rules:
...
It aims at solving the problem of keeping validation rules in sync with the
documentation.
